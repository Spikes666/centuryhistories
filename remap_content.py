...
# Keys must be specific enough not to match unrelated facts
REGIONS = [
    ...
    {"k":["waterloo, belgium","battle of waterloo"], "lat":50.7, "lng":4.4, "z":9, "l":"Waterloo, Belgium"},
    ...
    {"k":["march on washington","mlk","martin luther king"], "lat":38.9,"lng":-77.0,"z":9,"l":"Washington D.C."},
    ...
    {"k":["signing of magna carta","runnymede"], "lat":51.4,"lng":-0.6,"z":9,"l":"Runnymede, England"},
    {"k":["boston tea party","boston massacre"], "lat":42.4,"lng":-71.1,"z":9,"l":"Boston, Massachusetts"},
    {"k":["john locke","locke argued","locke's two"], "lat":51.5,"lng":-0.1,"z":7,"l":"England (John Locke)"},
    {"k":["declaration of independence","july 4","continental congress"], "lat":39.9,"lng":-75.2,"z":8,"l":"Philadelphia, Pennsylvania"},
    ...
    # ── Specific councils / events by location ──
    {"k":["council of nicaea"],             "lat":40.4,  "lng":29.7,  "z":8, "l":"Nicaea (İznik), Turkey"},
    {"k":["council of ephesus"],            "lat":37.9,  "lng":27.3,  "z":8, "l":"Ephesus, Turkey"},
    {"k":["council of chalcedon"],          "lat":40.9,  "lng":29.1,  "z":8, "l":"Chalcedon (Kadıköy), Turkey"},
    ...
    # ── Specific people by location ──
    {"k":["wittenberg","95 theses","luther nailed"], "lat":51.9,"lng":12.6,"z":9,"l":"Wittenberg, Germany"},
    {"k":["calvin","calvinist","reformed church in geneva"], "lat":46.2,"lng":6.1,"z":8,"l":"Geneva, Switzerland"},
    {"k":["polycarp of smyrna"],            "lat":38.4,  "lng":27.1,  "z":8, "l":"Smyrna (İzmir), Turkey"},
    ...
    {"k":["athanasius of alexandria"],      "lat":31.2,  "lng":29.9,  "z":8, "l":"Alexandria, Egypt"},
    {"k":["origen of alexandria"],          "lat":31.2,  "lng":29.9,  "z":8, "l":"Alexandria, Egypt"},
    {"k":["hypatia"],                       "lat":31.2,  "lng":29.9,  "z":8, "l":"Alexandria, Egypt"},
    ...
    {"k":["alexandria, egypt","library of alexandria","serapeum"], "lat":31.2,"lng":29.9,"z":8,"l":"Alexandria, Egypt"},
    {"k":["carthage"],                      "lat":36.9,  "lng":10.3,  "z":8, "l":"Carthage (near Tunis), Tunisia"},
    {"k":["córdoba","cordoba, spain"],      "lat":37.9,  "lng":-4.8,  "z":8, "l":"Córdoba, Spain"},
    ...
    {"k":["oxford university","university of oxford"], "lat":51.8,"lng":-1.3,"z":9,"l":"Oxford, England"},
    ...
    {"k":["washington, d.c.","washington d.c","white house","capitol"],    "lat":38.9,"lng":-77.0,"z":9,"l":"Washington D.C."},
    ...
    {"k":["arabian peninsula","mecca,","medina,","hijra","islam spread","arab conquest","umayyad","abbasid caliphate","the caliphate","quran was"], "lat":24.0,"lng":45.0,"z":5,"l":"Arabian Peninsula"},
    {"k":["ottoman empire","ottoman sultan","ottoman forces","ottoman turks","suleiman","mehmed ii","mehmed the"], "lat":39.0,"lng":35.0,"z":5,"l":"Ottoman Empire (modern Turkey)"},
    {"k":["byzantine empire","byzantine emperor","byzantine forces","byzantine culture"], "lat":41.0,"lng":29.0,"z":5,"l":"Byzantine Empire"},
    {"k":["roman empire","pax romana","roman roads","roman citizenship","roman province","roman world"], "lat":41.9,"lng":12.5,"z":4,"l":"The Roman Empire"},
    {"k":["rome,","in rome","of rome","sacked rome","emperor nero","emperor augustus","emperor vespasian","imperial rome","roman senate"], "lat":41.9,"lng":12.5,"z":7,"l":"Rome, Italy"},
    {"k":["judea","judah","israel","hebrew bible","jewish revolt","jewish war","jewish community","jewish leader","jewish sect","jewish preacher","maccab","hasmonean","zealot","pharisee","essene","bar kokhba"], "lat":31.8,"lng":35.2,"z":6,"l":"Judea / Israel"},
    {"k":["greece","greek philosophy","greek culture","helleni","macedon","alexander the great","neoplatonism","plotinus","proclus"], "lat":38.0,"lng":23.7,"z":6,"l":"Greece"},
    ...
    {"k":["spain","iberian","reconquista","al-andalus","castile","aragon","spanish inquisition","spanish armada","cortes,","pizarro"], "lat":40.4,"lng":-3.7,"z":5,"l":"Spain"},
    {"k":["italy","italian city","papal states","the papacy","the pope","the vatican","renaissance italy"], "lat":42.5,"lng":12.5,"z":5,"l":"Italy"},
    ...
    {"k":["russia","soviet union","ussr","bolshevik","tsar nicholas","romanov dynasty","russian revolution","russian empire"], "lat":55.8,"lng":37.6,"z":4,"l":"Russia"},
    ...
    {"k":["mongol empire","mongol conquest","mongol invasion","genghis khan","kublai khan","mongolia"], "lat":47.9,"lng":106.9,"z":4,"l":"Mongolia"},
    {"k":["united states","american civil war","american revolution","american independence","american colony","american president","american history"], "lat":38.9,"lng":-95.7,"z":4,"l":"United States"},
    ...
    {"k":["central asia","silk road","samarkand","bukhara","timur","tamerlane"], "lat":41.3,"lng":64.6,"z":5,"l":"Central Asia"},
    {"k":["the balkans","balkan","serbia","hungary","bohemia","croatia","visigoth","ostrogoth"], "lat":45.0,"lng":18.0,"z":5,"l":"The Balkans"},
    {"k":["atlantic ocean","pacific ocean","age of exploration","circumnavigation","columbus","magellan","drake,","cook,"], "lat":10.0,"lng":-30.0,"z":3,"l":"Age of Exploration"},
    {"k":["early christian","christian community","christian church","christianity spread","new testament","old testament","the gospels","the gospel of","gospel of mark","gospel of matthew","gospel of john","gospel of luke","gospel of thomas","the epistles","paul's letter","bart ehrman","misquoting jesus","textual criticism","biblical manuscript","biblical canon","dead sea"], "lat":35.0,"lng":25.0,"z":4,"l":"The Early Christian World"},
    ...
    {"k":["cold war","iron curtain","nato alliance","warsaw pact","nuclear arms","nuclear deterren"], "lat":52.0,"lng":20.0,"z":3,"l":"Cold War Europe"},
    {"k":["large language model","artificial intelligence","chatgpt","machine learning","neural network","generative ai"], "lat":20.0,"lng":0.0,"z":2,"l":"The Modern World"},
    {"k":["industrial revolution","steam engine","factory system","textile mill","coal mine","spinning jenny","power loom"], "lat":52.5,"lng":-1.9,"z":6,"l":"Industrial Revolution — England"},
    {"k":["french revolution","reign of terror","robespierre","the bastille","storming of"], "lat":48.9,"lng":2.3,"z":7,"l":"Paris, France"},
    {"k":["internet","world wide web","social media","artificial intelligence","ai model","large language model","machine learning","covid-19","climate change","paris agreement","global pandemic"], "lat":20.0,"lng":0.0,"z":2,"l":"The Modern World"},
]
...
# Fix era name while we're at it
...
# Spot check previously wrong facts
checks = [
    "Justinian Code",
    "Adam Smith",
    "moon landing",
...
for century in data['centuries']:
    for fact in century['facts']:
        for check in checks:
            if check.lower() in fact['fact'].lower():
                print(f"  [{fact['map_label']}] {fact['fact'][:75]}...")